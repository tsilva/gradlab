...
const ALL_PANELS_LAYOUT = Object.freeze({
  ...
  value: { x: 0, y: 23, w: 4, h: 8, visible: true, window: "main" },
  events: { x: 4, y: 22, w: 4, h: 7, visible: true, window: "main" },
  signals: { x: 8, y: 22, w: 4, h: 8, visible: true, window: "main" },
  raw: { x: 0, y: 31, w: 12, h: 7, visible: false, window: "main" },
  "reward-analysis": { x: 0, y: 31, w: 12, h: 15, visible: true, window: "main" },
  attribution: { x: 0, y: 46, w: 4, h: 15, visible: false, window: "main" },
  cnn: { x: 4, y: 46, w: 8, h: 15, visible: false, window: "main" },
});
