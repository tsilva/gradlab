...
const WORKSPACE_ID_KEY = "gradlab.player.workspace.id";
const LAYOUT_KEY = pairedWorkspace
  ? "gradlab.player.workspace.v4.paired"
  : "gradlab.player.workspace.v4.single";
const SAVED_LAYOUTS_KEY = "gradlab.player.workspace.saved.v4";
