...
def _check_report(args: argparse.Namespace) -> dict[str, Any]:
    ...
    try:
        ...
        editable_source_root = (
            ...
            if provider.provider_id == GRADLAB_PROVIDER.provider_id
            else None
        )
        ...
        _record(report, stage, "passed", "task binding and one gradlab/SB3-facade step succeeded")
    except Exception as exc:
