...
PUBLIC_OBJECT_USER_AGENT = "gradlab-public-client/1.0 (+https://github.com/tsilva/gradlab)"
...
class RunStorageConfig:
    ...
    def from_env(
        ...
        result = cls(
            control=BucketConfig.from_env("GRADLAB_CONTROL_R2", environment=environment),
            evaluation=BucketConfig.from_env("GRADLAB_EVAL_R2", environment=environment),
