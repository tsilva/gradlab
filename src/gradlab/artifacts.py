...
def build_model_provenance(
    ...
    provenance = {
        ...
        "goal_variant_id": train_config.get("goal_variant_id", ""),
        "goal_variant_label": train_config.get("goal_variant_label", ""),
        "goal_variant_source_relation": train_config.get("goal_variant_source_relation", ""),
        "goal_variant_descriptor_sha256": train_config.get("goal_variant_descriptor_sha256", ""),
