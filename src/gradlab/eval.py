...
from gradlab.env_config import env_config_from_args, parse_obs_crop
from gradlab.eval_runner import evaluate_model_episodes, evaluate_policy_bundle
...
def build_parser(*, prog: str = "gradlab eval") -> argparse.ArgumentParser:
    ...
    add_model_source_args(
        ...
        model_help="Path to an gradlab .zip policy artifact",
    )
