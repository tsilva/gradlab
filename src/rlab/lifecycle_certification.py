...
IMAGE_REF = "docker:registry.example/rlab-certification@sha256:" + "b" * 64
...
def run_simulated_certification(
    *,
    ...
    if artifact_root is None:
        owned_temporary = tempfile.TemporaryDirectory(prefix="rlab-tier1-")
