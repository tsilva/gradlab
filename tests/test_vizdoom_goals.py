...
EXPECTED_GOALS = {
    "VizdoomBasic-v1": {
        "timesteps": 2_000_000,
        "event": "monster_hit",
        "training_metric": "train/target/success/start_rate_min",
        "acceptance_metric": "eval/success/start_rate_min",
    ...
    "VizdoomDeadlyCorridor-v1": {
        ...
        "acceptance_metric": "eval/return_mean",
    ...
    "VizdoomDeathmatch-v1": {
        ...
        "training_metric": "train/target/success/start_rate_min",
        "training_threshold": 1.0,
        "acceptance_metric": "eval/progress/kills/mean",
