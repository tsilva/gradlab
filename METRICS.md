...
| `train/early_stop/{condition}/patience/progress` | Early-stop {condition} patience | Policy-step patience progress capped at one; one means the condition would trigger. | fraction | watched metric sample | history | last |
